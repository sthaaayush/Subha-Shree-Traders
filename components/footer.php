<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="#"><i class="fas fa-envelope"></i> subhashreetraders@gmail.com</a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Subha Shree Traders</span> | all rights reserved!</div>
